...
public class homepage extends JFrame {
    ...
    public homepage() {
        ...
        InfoLabel userLabel = new InfoLabel("User : XXXXXX"); // ต้องเชื่อมกับ data จากหน้าล้อกอิน
        InfoLabel winrateLabel = new InfoLabel("Winrate : 00%"); // ต้องเชื่อมกับ data จากหน้าล้อกอิน **ยังไม่มีโค้ดรองรับ
        bg.add(userLabel);
        bg.add(winrateLabel);
    ...
    private JPanel createLoginPanel() {
        ...
        JButton btnS = createStyledButton("Play with Friends", new Color(90, 0, 0)); //linkไปหน้า create room
